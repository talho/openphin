Feature: Generate a Report from the User-All-Batch-Recipe
  ...
  Scenario: Initiate the viewing of a report contents
    ...
    Then I should see "User-All-Batch-Recipe-3.csv" within ".document-file-icon-view"
    ...
    When I select the "Reports" grid row
    Then I should see "User-All-Batch-Recipe-3.pdf" within ".document-file-icon-view"

    When I generate "RecipeExternal::UserAllBatchRecipe" report
