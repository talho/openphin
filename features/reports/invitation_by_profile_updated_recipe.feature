Feature:
  ...
  @clear_report_db
  Scenario: Reporting invitation completion status by profile update
    ...
    Then I should see "Registrations complete: 40% (2)" in the rendering
    ...
    And I should see "Not Email Confirmed" in the rendering

    When I inspect the generated pdf
    Then I should see "Registrations complete: 40% (2)" in the pdf
    ...
    And I should see "Not Email Confirmed" in the pdf
    ...
    And I should see "Not Email Confirmed" in the csv
