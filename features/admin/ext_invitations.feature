Feature: Invitation System
  ...
  Scenario: View the list of existing invitations to organizations
    ...
    And I should see "Jane" within "#invitationGrid"
    And I should see "jane.smith@example.com" within "#invitationGrid"
    And I should see "Bob" within "#invitationGrid"
    And I should see "bob.smith@example.com" within "#invitationGrid"
    # DEV NOTE: Previous version was expecting Jane on row 1 and Bob on row 2, but environment is not consisted
