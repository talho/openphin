=OpenPHIN
OpenPHIN is a portal for public health related projects.
...
4. RubyGems
5. Rails 2.3
6. ClamAV >= 0.96 and at least 'main.cvd' from http://clamav.net ( to enable, uncomment the lines in initializers/clamav.rb )
7. Git (not required to run, but well help getting it installed)
