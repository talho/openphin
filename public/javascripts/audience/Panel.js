 ...
 */
Ext.define('Talho.audience.Panel', {
    extend: 'Ext.Container',
    alertnateClassName: ['Ext.ux.AudiencePanel'],
    alias: ['widget.audiencepanel'],
    uses: ['Talho.model.Jurisdiction', 'Talho.store.Jurisdictions', 'Talho.audience.JurisdictionsTree', 'Talho.ux.DoNotCollapseActive'],
    /**
    ...
    initComponent: function() {
        ...
        this.accordion = new Ext.Panel({
            ...
            layout: {type: 'accordion', align: 'stretch'},
            flex: 3,
            layoutConfig: { hideCollapseTool: true, animate: true },
            items: {xtype: 'jurisdictionstree'},//items,
            margins: '0 20 0 0',
            activeItem: 0,
        ...
        Talho.audience.Panel.superclass.initComponent.call(this);
    },
    ...
    _createJurisdictionsTree: function(){
        return this.jurisdictionTree = Ext.create('Talho.audience.JurisdictionsTree', {
            store_listeners:{
                scope: this,
                'load': function(){
