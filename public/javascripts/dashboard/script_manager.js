...
(function(){
    ...
    var regList = {
      ...
      'Talho.Dashboard.CMS.Admin': {js: '$(ext_extensions)/xActionColumn.js $(ext_extensions)/PhinHtmlEditor.js $(ext_extensions)/Portal.js > ( $(cms)/portlet.js > ( $(cms)/portlets/html.js > $(cms)/portlets/phin.js ) $(cms)/portlets/rss.js ) $(cms)/views/admin_toolbar.js $(cms)/views/view_portal.js $(cms)/views/admin_portal.js $(cms)/views/new_dashboard_window.js $(cms)/views/open_dashboard_window.js AudiencePanel $(cms)/views/manage_permissions_window.js $(cms)/admin_controller.js'}
    };
    ...
    dominoes.rule('Dashboard', '$(ext_extensions)/Portal.js > ( $(cms)/portlet.js > ( $(cms)/portlets/html.js > $(cms)/portlets/phin.js ) $(cms)/portlets/rss.js ) $(cms)/views/view_portal.js $(cms)/view_controller.js');
