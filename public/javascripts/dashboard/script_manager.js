...
(function(){
    ...
    dominoes.rule('Portlets', '$(ext_extensions)/Portal.js > ( $(cms)/portlet.js > ( $(cms)/portlets/html.js > $(cms)/portlets/phin.js ) $(cms)/portlets/rss.js ( $(ext_extensions)/jsonp.js $(cms)/portlets/twitter.js ) )')
