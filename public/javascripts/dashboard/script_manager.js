...
(function(){
    ...
    dominoes.rule('Dashboard', '$(ext_extensions)/Portal.js > ( $(cms)/portlet.js > ( $(cms)/portlets/html.js > $(cms)/portlets/phin.js ) ) $(cms)/views/view_portal.js $(cms)/view_controller.js');
