...
Talho.Dashboard.CMS.Views.AdminToolbar = Ext.extend(Ext.Toolbar, {
  initComponent: function(){
    this.items = [
      ...
      '|',
      {text: 'Preview', itemId: 'preview_button', handler: this.togglePreview.bind(this, ['preview_button', 'editview_button'])},
      {text: 'Edit View', itemId: 'editview_button', handler: this.togglePreview.bind(this, ['editview_button', 'preview_button']), hidden: true},
      '|',
