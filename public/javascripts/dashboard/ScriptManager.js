...
(function(){
    ...
    var regList = {
        ...
        'Talho.Documents': {js: 'TreeGrid $(ext_extensions)/xActionColumn.js $(ext_extensions)/SubmitFalse.js AudiencePanel /javascripts/documents/AddEditFolderWindow.js /javascripts/documents/DocumentViews.js /javascripts/documents/Documents.js'},
        'Talho.DocumentSearch': {js: '/javascripts/documents/DocumentViews.js /javascripts/documents/DocumentSearch.js'},
