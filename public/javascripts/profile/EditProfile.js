...
Talho.EditProfile = Ext.extend(Talho.ProfileBase, {
  constructor: function(config){
    var item_list = [
      {xtype: 'container', layout: 'form', labelAlign: 'left', defaults:{width:400}, items:[
      ...
      {xtype: 'container', layout: 'form', labelAlign: 'top', defaults:{width:200}, items:[
        {xtype: 'container', html: '<img src="images/missing.jpg" width=200 height=200><br>&nbsp;'},
        {xtype: 'textfield', inputType: 'file', fieldLabel: 'Picture to upload', name: 'profile[name]', maxLength: '15', allowBlank: false},
